            ...
            <table width="544" border="0" cellpadding="0" cellspacing="0" class="eBox"
                ...
                <tr>
                    <td class="eBody pdTp32" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 32px;padding-bottom: 0;padding-left: 16px;padding-right: 16px;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;width: 512px;color: #ffffff;background-color: #343843;">
                        <p style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 24px!important;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;font-size: 14px;line-height: 22px;text-align: left;">${i18n.__('EMAIL_HI')} ${model.firstName},<br><br>
                        ${model.body}</p>
...
function text(model) {
    return `
${i18n.__('EMAIL_HI')} ${model.firstName},

${model.body}

${i18n.__('EMAIL_THANKS')},
