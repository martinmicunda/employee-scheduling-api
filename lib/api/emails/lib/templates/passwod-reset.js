...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 560px) {
            ...
            table[class=mainBtn], table[class~=mainBtn] {
...
<div class="emailSummary"
    ...
    ${i18n.__('EMAIL_PASSWORD_RESET_SUMMARY')}
</div>
    ...
    <tr>
        <td align="center" valign="top" class="emailBodyCell"
            ...
            <table width="544" border="0" cellpadding="0" cellspacing="0" class="eBox"
                ...
                <tr>
                    <td class="eBody pdTp32" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 32px;padding-bottom: 0;padding-left: 16px;padding-right: 16px;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;width: 512px;color: #ffffff;background-color: #343843;">
                        <p style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 24px!important;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;font-size: 14px;line-height: 22px;text-align: left;">${i18n.__('EMAIL_HI')} ${model.firstName} ${model.lastName},<br><br>
                        ${i18n.__('EMAIL_PASSWORD_RESET_BODY')}</p>

                        <table border="0" cellpadding="0" cellspacing="0" class="mainBtn"
                               style="margin-top: 0;margin-left: auto;margin-right: auto;margin-bottom: 24px;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-collapse: collapse;border-spacing: 0;">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="btnMain"
                                    ...
                                    <a href="http://${config.email.host}:${config.email.port}/reset-password/${token}"
                                       style="padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;color: #ffffff;font-weight: bold;"><span
                                        style="text-decoration: none;color: #ffffff;">${i18n.__('EMAIL_PASSWORD_RESET_BUTTON')}</span></a>
                                </td>
                                <td class="emptyCell"
                                    style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;background-color: #00acac;line-height: 0 !important;font-size: 0 !important;">
                                    &nbsp;</td>
                        ...
                        <p>${i18n.__('EMAIL_PASSWORD_RESET_FOOTER')}</p>

                        <p style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 24px;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;font-size: 14px;line-height: 22px;text-align: left;">${i18n.__('EMAIL_THANKS')},<br>
                            ${i18n.__('EMAIL_SIGNATURE', config.email.projectName)}</p>
                    </td>
                    <!-- end .eBody-->
                </tr>
                <tr>
