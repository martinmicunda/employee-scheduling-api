...
const routes = [
    {
        ...
        handler: function *() {
            if(this.request.query.employeeId) {
                this.body = yield dao.findByEmployeeId(this.request.query.employeeId, this.request.query.start, this.request.query.end);
            } else {
                this.body = yield dao.find(this.request.query.start, this.request.query.end);
            }
        }
    },
    {
