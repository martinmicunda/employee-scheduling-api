...
const routes = [
    {
        ...
        handler: function *() {
            this.body = yield dao.findByID(this.params.id);
        }
    },
    {
        method: 'GET',
    ...
    },
    {
        ...
        handler: function *() {
            this.body = yield dao.insert(this.request.body);
            this.status = 201;
        }
    },
    {
    ...
    },
    {
        ...
        handler: function *() {
            this.body = yield employeeService.findAccountDetails(this.params.id);
        }
    },
    {
        method: 'PUT',
        ...
        handler: function *() {
            this.body = yield employeeService.updateAccountDetails(this.params.id, this.request.body);
        }
    }
];
