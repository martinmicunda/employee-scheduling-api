...
const routes = [
    {
        ...
        handler: function *() {
            ...
            //const profile = yield service.authenticate(credentials.email, credentials.password);
            const profile = {id: '12345', firstName: 'Martin', lastName: 'Micunda', role: 'admin', avatar: 'https://raw.githubusercontent.com/martinmicunda/employee-scheduling-ui/master/src/images/avatar.png'};
            /**
