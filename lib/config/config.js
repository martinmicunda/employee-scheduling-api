...
const config = Object.freeze({
    ...
    email: {
        imageCDN: 'https://raw.githubusercontent.com/martinmicunda/employee-scheduling-api/master/lib/api/emails/lib/templates/images/',
        support: 'support@e-scheduling.com',
        host: process.env.NODE_HOST || 'localhost',
        port: process.env.EMAIL_PORT || '8000',
        projectName: 'Employee Scheduling',
        copyright: 'Martin Micunda',
        copyrightLink: 'http://www.martinmicunda.com'
    },
